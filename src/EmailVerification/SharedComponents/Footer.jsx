                ...
                <div className=" flex border-b gap-6">
                    ...
                    <div className="flex gap-14 pb-20 pr-10">
                        <div className="space-y-6 text-zinc-700 ">
                            <h1 className="text-black font-bold">For designers</h1>
                            <h1>Go Pro!</h1>
                        ...
                        <div className="space-y-6 text-zinc-700">
                            <h1 className=" text-black font-bold">Hire designers</h1>
                            <h1>Post a job Openining</h1>
                            <div>
                                <h1>Post a freelance</h1>
                                <h1>Project</h1>
                            </div>
                            <h1>Search for designers</h1>
                            <h1 className="text-black font-bold">Brands</h1>
                        ...
                        <div className="space-y-6 text-zinc-700">
                            <h1 className="text-black font-bold">Directories</h1>
                            <h1>Design jobs</h1>
                            <div>
                                <h1>Freelance designers</h1>
                                <h1>for hire</h1>
                            </div>
                            <h1>Tags</h1>
                            <h1>Places</h1>
                            <h1 className="text-black font-bold">Design assets</h1>
                            <h1>Dribbble Marketplace</h1>
                        ...
                        <div className="space-y-6 text-zinc-700">
                            <h1 className=" text-black font-bold">Design Resources</h1>
                            <h1>Freelancing</h1>
                            <h1>Design Hiring</h1>
                ...
                <div className="flex justify-between pt-12 pb-5">
                    ...
                    <div className="flex">
                        <p className="font-bold self-center">
                            20,501,853 <span className="text-zinc-500">shots dribbbled</span>
                        </p>
                        <img
                            className="h-7"
                            src="https://res.cloudinary.com/df8suxer2/image/upload/v1713086204/zerctu4imvg0y6q6ulgk.png"
                            alt="logo"
                        />
                    </div>
                </div>
