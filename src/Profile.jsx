    ...
    return (
        <div >
            <div className='flex lg:justify-start  justify-center h-28 '>
                <img className="h-20 self-center pl-5" src="/dribbble.png" alt="logo" />
            </div>
                    ...
                    <div className=' flex flex-col items-start mt-14 ' >
                        <div className='space-y-3 '>
                            ...
                            <div className=' w-full '>
                                <input className=" border-b-2 outline-none" placeholder='Enter Your Location'></input>
                            </div>
                            <div >
                                <button className={`mt-8 text-white px-20 py-2 rounded-md ${imageUrl ? 'bg-pink-500' : 'bg-pink-300'}`}>
                                    Next</button>
                            </div>
                        </div>
                    </div>
